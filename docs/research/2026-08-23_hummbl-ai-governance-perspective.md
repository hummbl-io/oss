...
4. **Publish the Unified Ontology**:
   - Update `docs/architecture/MONOREPO-DESIGN.md` and `docs/operations/FULL-MENU.md` to reference this field-mapping taxonomy as the structural justification for our multi-package architecture.
