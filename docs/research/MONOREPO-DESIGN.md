...
[`docs/research/PACKAGES.md`](PACKAGES.md) (~100 candidates across 10 registries).
...
4. Update `docs/research/PACKAGES.md` inventory and the root `README.md` package
   table
...
- [x] Create `docs/research/MONOREPO-DESIGN.md` (this file)
- [ ] Create `docs/research/PACKAGES.md` (full inventory from the survey)
