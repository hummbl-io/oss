...
**Why this file exists:** `docs/architecture/FLEET-GOVERNANCE-MAPPING.md` (2026-08-21) cited this path. It was not in the org.
...
`docs/architecture/FLEET-GOVERNANCE-MAPPING.md` listed "IETF HDP, DCT, `delegation_chain` JWT" as one emerging-standards cell. That collapses three layers and one non-IETF paper:
...
1. **Fix the mapping citation** in `docs/architecture/FLEET-GOVERNANCE-MAPPING.md`: point here; split HDP / AAT / DCT-paper.
...
- `docs/architecture/FLEET-GOVERNANCE-MAPPING.md` (2026-08-21)
