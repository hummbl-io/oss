...
| `base120` | 3.0.2 | 3.0.0 | 120 reasoning operators. Tree 3.0.2 is the NOTICE-aligned wheel (issue #141); PyPI 3.0.0 is not yanked. 3.0.1 was tagged but not published. |
