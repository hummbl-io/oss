...
| CC2: Communication and Information        | Coordination bus (TSV), KRINEIA receipts, claims manifest                            | hummbl_governance/_state/coordination/messages.tsv, _receipts/krineia/primary.jsonl, web/manifest/claims-provenance.json |
