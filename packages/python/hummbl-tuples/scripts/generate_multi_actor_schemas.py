...
def make_schema(
    ...
    required_data_fields: list = None,
) -> dict:
    ...
    return {
        ...
        "properties": {
            ...
            "control_mode": {
                "type": "string",
                "enum": ["USER_DIRECT", "AI_PROPOSE_USER_CONFIRM", "AI_AUTONOMOUS"],
            },
            "tuple_data": {
                "type": "object",
                "additionalProperties": False,
...
SCHEMAS = [
    (
        "AGENT_REGISTERED",
        "Multi-Actor AGENT_REGISTERED Tuple",
    ...
    (
        ...
        "Multi-Actor AGENT_VERSION_CHANGED Tuple",
    ...
    (
        "AGENT_ROLE_ASSIGNED",
        "Multi-Actor AGENT_ROLE_ASSIGNED Tuple",
    ...
    (
        "AGENT_ROLE_EXPIRED",
        "Multi-Actor AGENT_ROLE_EXPIRED Tuple",
    ...
    (
        "DELEGATION_GRANTED",
        "Multi-Actor DELEGATION_GRANTED Tuple",
    ...
    (
        "DELEGATION_REVOKED",
        "Multi-Actor DELEGATION_REVOKED Tuple",
    ...
    (
        "AGENT_OBSERVATION",
        "Multi-Actor AGENT_OBSERVATION Tuple",
        "Records an observation by an agent, distinct from user observation.",
        {"observation_content": {"type": "string"}, "target_model": {"type": "string"}},
        ["observation_content"],
    ),
    (
        "AGENT_INFERENCE",
        "Multi-Actor AGENT_INFERENCE Tuple",
    ...
    (
        ...
        "Multi-Actor AGENT_MODEL_PROPOSAL Tuple",
    ...
    (
        "AGENT_CHALLENGE",
        "Multi-Actor AGENT_CHALLENGE Tuple",
    ...
    (
        "AGENT_DISSENT",
        "Multi-Actor AGENT_DISSENT Tuple",
        "Records agent dissent. Dissent survives handoff and bounded decisions.",
        {
            ...
            "resolution_posture": {
                "type": "string",
                "enum": ["unresolved", "partially_resolved", "resolved", "superseded"],
            },
        },
    ...
    (
        "USER_RATIFICATION",
        "Multi-Actor USER_RATIFICATION Tuple",
    ...
    (
        "USER_REJECTION",
        "Multi-Actor USER_REJECTION Tuple",
    ...
    (
        "ORG_RATIFICATION",
        "Multi-Actor ORG_RATIFICATION Tuple",
    ...
    (
        "ORG_REJECTION",
        "Multi-Actor ORG_REJECTION Tuple",
    ...
    (
        ...
        "Multi-Actor MODEL_MERGE_PROPOSAL Tuple",
        ...
        [
            "source_model_a",
            "source_model_b",
            "proposed_merged_model",
            "unresolved_dissent_acknowledged",
        ],
    ),
    (
        "MODEL_MERGE_ACCEPTED",
        "Multi-Actor MODEL_MERGE_ACCEPTED Tuple",
    ...
    (
        "MODEL_MERGE_REJECTED",
        "Multi-Actor MODEL_MERGE_REJECTED Tuple",
    ...
    (
        "HANDOFF_EVENT",
        "Multi-Actor HANDOFF_EVENT Tuple",
    ...
    (
        ...
        "Multi-Actor TOOL_RESULT_PROPOSED Tuple",
    ...
    (
        ...
        "Multi-Actor TOOL_RESULT_ADMITTED Tuple",
    ...
    (
        "ACTION_PROPOSED",
        "Multi-Actor ACTION_PROPOSED Tuple",
    ...
    (
        "ACTION_AUTHORIZED",
        "Multi-Actor ACTION_AUTHORIZED Tuple",
    ...
    (
        "ACTION_DENIED",
        "Multi-Actor ACTION_DENIED Tuple",
    ...
    (
        "ACTION_EXECUTED",
        "Multi-Actor ACTION_EXECUTED Tuple",
    ...
    (
        ...
        "Multi-Actor AGENT_CALIBRATION_UPDATED Tuple",
    ...
    (
        "COALITION_FORMED",
        "Multi-Actor COALITION_FORMED Tuple",
    ...
    (
        "COALITION_MEMBERSHIP_CHANGED",
        "Multi-Actor COALITION_MEMBERSHIP_CHANGED Tuple",
    ...
    (
        "COALITION_DISSOLVED",
        "Multi-Actor COALITION_DISSOLVED Tuple",
    ...
    (
        "AGENT_QUARANTINED",
        "Multi-Actor AGENT_QUARANTINED Tuple",
    ...
    (
        "AGENT_REBOUND",
        "Multi-Actor AGENT_REBOUND Tuple",
