...
EXAMPLES_DIR = os.path.join(
    ...
    "examples", "multi_actor",
)
INVALID_DIR = os.path.join(EXAMPLES_DIR, "invalid")


def base_event(tuple_type: str, eid: str, actor: str, principal: str,
               control_mode: str, actor_regime: str,
               authored_by: str, represented_principal: str,
               owner: str, receipted_by: str,
...
VALID_FIXTURES = [
    ...
    ("01a-agent-inference.json", "AGENT_INFERENCE", "agent-a",
     "user-001", "AI_PROPOSE_USER_CONFIRM", "user_plus_agent",
     "agent-a", "user-001", "user-001", "receipt-001",
    ...
    ("01b-user-rejection.json", "USER_REJECTION", "user-001",
     "user-001", "USER_DIRECT", "user_only",
     "user-001", "user-001", "user-001", "receipt-002",
    ...
    ("02a-agent-inference.json", "AGENT_INFERENCE", "agent-b",
     "user-002", "AI_PROPOSE_USER_CONFIRM", "user_plus_agent",
     "agent-b", "user-002", "user-002", "receipt-003",
     {"inference_content": "Code review bottleneck is slowing merges",
      "target_model": "umf-002",
      "inference_basis": ["metrics-001"],
      "epistemic_permission": "infer"}),
    ("02b-user-ratification.json", "USER_RATIFICATION", "user-002",
     "user-002", "USER_DIRECT", "user_only",
     "user-002", "user-002", "user-002", "receipt-004",
    ...
    ("03-correlated-agents.json", "AGENT_INFERENCE", "agent-c1",
     "user-003", "AI_PROPOSE_USER_CONFIRM", "user_plus_agent_team",
     "agent-c1", "user-003", "user-003", "receipt-005",
    ...
    ("04-independent-corroboration.json", "AGENT_INFERENCE", "agent-d1",
     "user-004", "AI_PROPOSE_USER_CONFIRM", "user_plus_agent_team",
     "agent-d1", "user-004", "user-004", "receipt-006",
    ...
    ("05a-agent-dissent.json", "AGENT_DISSENT", "agent-e2",
     "user-005", "AI_PROPOSE_USER_CONFIRM", "user_plus_agent_team",
     "agent-e2", "user-005", "user-005", "receipt-007",
     {"dissented_claim": "Redesign improved satisfaction",
      ...
      "epistemic_permission": "challenge"}),
    ("05b-action-authorized.json", "ACTION_AUTHORIZED", "user-005",
     "user-005", "USER_DIRECT", "user_only",
     "user-005", "user-005", "user-005", "receipt-008",
    ...
    ("06a-model-fork.json", "MODEL_FORK", "user-006",
     "user-006", "USER_DIRECT", "user_only",
     "user-006", "user-006", "user-006", "receipt-009",
    ...
    ("06b-merge-proposal.json", "MODEL_MERGE_PROPOSAL", "agent-f1",
     "user-006", "AI_PROPOSE_USER_CONFIRM", "user_plus_agent",
     "agent-f1", "user-006", "user-006", "receipt-010",
    ...
    ("07a-coalition-formed.json", "COALITION_FORMED", "user-007",
     "user-007", "USER_DIRECT", "organization_plus_agents",
     "user-007", "user-007", "org-007", "receipt-011",
     {"coalition_id": "coal-001",
      ...
      "action_permission": "none"}),
    ("07b-coalition-dissolved.json", "COALITION_DISSOLVED", "user-007",
     "user-007", "USER_DIRECT", "organization_plus_agents",
     "user-007", "user-007", "org-007", "receipt-012",
     {"coalition_id": "coal-001",
    ...
    ("08a-agent-version-changed.json", "AGENT_VERSION_CHANGED", "agent-h1",
     "user-008", "AI_PROPOSE_USER_CONFIRM", "user_plus_agent",
     "agent-h1", "user-008", "user-008", "receipt-013",
     {"agent_id": "agent-h1",
      "previous_version": "v1.2",
      "new_version": "v2.0",
      "change_reason": "Model upgrade",
      "durable_write_permission": "none"}),
    ("08b-calibration-updated.json", "AGENT_CALIBRATION_UPDATED", "user-008",
     "user-008", "USER_DIRECT", "user_plus_agent",
     "user-008", "user-008", "user-008", "receipt-014",
     {"agent_id": "agent-h1",
    ...
    ("09a-delegation-granted.json", "DELEGATION_GRANTED", "user-009",
     "user-009", "USER_DIRECT", "user_plus_agent",
     "user-009", "user-009", "user-009", "receipt-015",
     {"delegation_id": "deleg-001",
      ...
      "action_permission": "none"}),
    ("09b-agent-observation.json", "AGENT_OBSERVATION", "agent-i1",
     "user-009", "AI_AUTONOMOUS", "bounded_agent_only",
     "agent-i1", "user-009", "user-009", "receipt-016",
...
INVALID_FIXTURES = [
    ...
    ("invalid/01-invalid-merge-hides-dissent.json", "MODEL_MERGE_PROPOSAL",
     "agent-bad-1", "user-bad-1", "AI_PROPOSE_USER_CONFIRM",
     "user_plus_agent", "agent-bad-1", "user-bad-1", "user-bad-1",
     "receipt-bad-001",
    ...
    ("invalid/02-invalid-coalition-self-expands.json", "COALITION_FORMED",
     "agent-bad-2", "user-bad-2", "AI_AUTONOMOUS",
     "bounded_agent_only", "agent-bad-2", "user-bad-2", "user-bad-2",
     "receipt-bad-002",
     {"coalition_id": "coal-bad-001",
      ...
      "action_permission": "execute_action"}),  # invalid: coalition can't grant action

    # Authority laundering through another agent
    ("invalid/03-authority-laundering.json", "ACTION_EXECUTED",
     "agent-bad-3", "user-bad-3", "AI_AUTONOMOUS",
     "bounded_agent_only", "agent-bad-3", "user-bad-3", "user-bad-3",
     "receipt-bad-003",
    ...
    ("invalid/04-revoked-delegation-used.json", "AGENT_OBSERVATION",
     "agent-bad-4", "user-bad-4", "AI_AUTONOMOUS",
     "bounded_agent_only", "agent-bad-4", "user-bad-4", "user-bad-4",
     "receipt-bad-004",
...
def main():
    ...
    for filename, ttype, actor, principal, cmode, regime, authored, repr_princ, owner, receipted, extra in VALID_FIXTURES:
        event = base_event(ttype, filename.replace(".json", "").split("-")[-1],
                          actor, principal, cmode, regime,
                          authored, repr_princ, owner, receipted, extra)
    ...
    for filename, ttype, actor, principal, cmode, regime, authored, repr_princ, owner, receipted, extra in INVALID_FIXTURES:
        eid = filename.replace(".json", "").split("/")[-1]
        event = base_event(ttype, eid, actor, principal, cmode, regime,
                          authored, repr_princ, owner, receipted, extra)
        path = os.path.join(EXAMPLES_DIR, filename)
