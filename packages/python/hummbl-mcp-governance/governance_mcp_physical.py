...
def _phri_check_safety(args: dict) -> dict:
    ...
    return {
        ...
        "reason": result["reason"],
        "safe": mode == PhysicalSafetyMode.NORMAL
        if isinstance(mode, PhysicalSafetyMode)
        else False,
        "inputs": {
            "distance": distance,
            "collision": collision,
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "mode": {
                    "type": "string",
                    "description": "normal | caution | emergency",
                },
            },
            "required": ["mode"],
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "distance": {
                    "type": "number",
                    "description": "Distance to human in meters",
                },
                "collision": {
                    "type": "boolean",
                    "description": "True if collision detected",
                },
            },
        },
    },
