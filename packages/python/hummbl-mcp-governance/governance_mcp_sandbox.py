...
class Sandbox:
    ...
    def _check_hard_blocks(self, tool):
        ...
        if self.kill_switch.engaged:
            return {
                "allowed": False,
                "reason": f"Kill switch engaged: {self.kill_switch.mode}",
            }
        if (
            hasattr(self.circuit_breaker, "state")
            and self.circuit_breaker.state.name == "OPEN"
        ):
            return {
                "allowed": False,
    ...
    def _check_policy(self, tool, path, cost):
        ...
        if self.allowed_tools and tool not in self.allowed_tools:
            reasons.append(
                f"Tool '{tool}' not in allowed set: {sorted(self.allowed_tools)}"
            )
        if path:
        ...
        if self.cost_spent + cost > self.max_cost:
            reasons.append(
                f"Cost ${self.cost_spent + cost:.2f} would exceed cap ${self.max_cost:.2f}"
            )
        return reasons
    ...
    def check_action(self, tool, path=None, cost=0.0):
        ...
        return {
            "allowed": True,
            "cost_remaining": round(self.max_cost - self.cost_spent, 2),
        }
...
TOOLS = [
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "max_cost": {
                    "type": "number",
                    "description": "Maximum cost in USD (default: 10.0)",
                    "default": 10.0,
                },
                "timeout_sec": {
                    "type": "integer",
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "path": {
                    "type": "string",
                    "description": "File path being accessed (optional)",
                },
                "cost": {
                    "type": "number",
                    "description": "Estimated cost of this action (default: 0)",
                    "default": 0,
                },
            },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "output": {
                    "type": "string",
                    "description": "Agent output text to validate",
                },
            },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                "sandbox_id": {
                    "type": "string",
                    "description": "Sandbox ID (omit for all sandboxes)",
                },
            },
            "required": [],
        },
