...
| `archived_memory_material` | `archive` | archive/backups | `Archive/`, `_internal-runner-mirror/`, `.claude/*.bak*`, `.agy/*.bak*` | read-only historical material unless promoted by review |
