...
hummbl turns plans, hypotheses, observations, evaluations, decisions, and reflections into durable, inspectable artifacts. It provides reasoning primitives, protocols (scientific method, quality assessment), capture from existing artifacts or live runtime hooks, planning, local analysis, scoring, and visualization.
...
- `protocols.py` — scientific method and quality assessment protocols
