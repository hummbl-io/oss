...
class AuditTrailPersistence:
    ...
    def __init__(self, base_dir: str = "_state/audit_trails", signing_key: str | None = None):
        """
    ...
    def load_audit_trail(self, audit_trail_id: str) -> dict[str, Any] | None:
        """
    ...
    def list_audit_trails(self, mission_id: str | None = None) -> list[str]:
        """
...
_persistence_instance: AuditTrailPersistence | None = None


def get_persistence(base_dir: str = "_state/audit_trails",
                    signing_key: str | None = None) -> AuditTrailPersistence:
    """
