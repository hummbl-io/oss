...
3. Update the package tables in `AGENTS.md`, `README.md`, `docs/research/PACKAGES.md`.
...
4. If the package was published to PyPI, note the last published version
   in `docs/research/PACKAGES.md` under a "Removed" section.
...
- The package is marked as "Archived" in `docs/research/PACKAGES.md`.
...
- An entry is added to `docs/research/PACKAGES.md` under "Removed" with the last
...
2. The extraction plan preserves:
   ...
   - License files
3. The monorepo's `docs/research/PACKAGES.md` is updated to note the extraction
